...
> Este documento se genera a partir del archivo Python original. [canvas.py](../../canvas.py) es la fuente de verdad.
...
- `from constants import DISPLAY_HEIGHT, DISPLAY_WIDTH, DMD_WIDGET_TYPES, LCD_WIDGET_TYPES, PREVIEW_SCALE, SOURCE_UNITS, resolve_icon_path`
