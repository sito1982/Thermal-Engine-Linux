---
generated: true
source_path: "dmd_transitions.py"
source_sha256: 5919726086f5671b4baa205e140e29b0c32c1df31c8605d61067569e0c06027f
source_bytes: 3807
source_lines: 101
generated_by: "scripts/generate_code_markdown.py"
---

# Código: `dmd_transitions.py`

> [!info] Representación generada
> Este documento se genera a partir del archivo Python original. [dmd_transitions.py](../../dmd_transitions.py) es la fuente de verdad.
        ...
        for element in screen.elements:
            ...
            if element.type == "dmd_panel":
                element.panel_values = {
                    src: sensor_data.get(src, element.panel_values.get(src, 0))
