...
# Código: `elements/line_chart.py`

> [!info] Representación generada
> Este documento se genera a partir del archivo Python original. [elements/line_chart.py](../../../elements/line_chart.py) es la fuente de verdad.
