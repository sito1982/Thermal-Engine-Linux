---
generated: true
source_path: "hwinfo_reader.py"
source_sha256: 5a723a013a27b83ed0f544c8a7461543f21bd98aca6681e47a55a86e4d3d52c2
source_bytes: 19492
source_lines: 556
generated_by: "scripts/generate_code_markdown.py"
---

# Código: `hwinfo_reader.py`

> [!info] Representación generada
> Este documento se genera a partir del archivo Python original. [hwinfo_reader.py](../../hwinfo_reader.py) es la fuente de verdad.
...
- `HWiNFO_SENSORS_SHARED_MEM_HEADER`
- `HWiNFOReader`
