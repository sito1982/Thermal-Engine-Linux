---
generated: true
source_path: "lcd_widgets.py"
source_sha256: c77299a3be45b658e00489104bb01b5ae502a15cfaead10cb0e49e2f5fc12c86
source_bytes: 31387
source_lines: 745
generated_by: "scripts/generate_code_markdown.py"
---

# Código: `lcd_widgets.py`

> [!info] Representación generada
> Este documento se genera a partir del archivo Python original. [lcd_widgets.py](../../lcd_widgets.py) es la fuente de verdad.
...
- `from constants import DEFAULT_FONT_FAMILY, SOURCE_UNITS`
...
class Ctx:
    ...
    def __init__(self, element, w, h):
        ...
        self.font_family = getattr(element, "font_family", DEFAULT_FONT_FAMILY) or DEFAULT_FONT_FAMILY
