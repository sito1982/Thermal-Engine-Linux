---
generated: true
source_path: "plugins/lite.py"
source_sha256: 721ddd5e7df2853f23a8d34db1fd7e0d5dcb5c5a99189442f711aafd6a0a4c76
source_bytes: 4816
source_lines: 146
generated_by: "scripts/generate_code_markdown.py"
---

# Código: `plugins/lite.py`

> [!info] Representación generada
> Este documento se genera a partir del archivo Python original. [plugins/lite.py](../../../plugins/lite.py) es la fuente de verdad.
